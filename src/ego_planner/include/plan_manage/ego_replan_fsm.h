...
#include <trajectory_msgs/DataDisp.h>
...
namespace ego_planner {
    ...
    private:
        ...
        trajectory_msgs::DataDisp data_disp_;
        ...
        void RecvBroadcastMINCOTrajCallback(const trajectory_msgs::MINCOTrajConstPtr &msg);

        void polyTraj2ROSMsg(trajectory_msgs::PolyTraj &poly_msg, trajectory_msgs::MINCOTraj &MINCO_msg);
