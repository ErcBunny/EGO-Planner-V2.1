...
mat Jplus1(const colvec &X1, const colvec &X2) {
    ...
    double Marr[9] = {-(X3(2 - 1) - X1(2 - 1)), (X3(3 - 1) - X1(3 - 1)) * cos(X1(4 - 1)),
                      ...
                      X3(1 - 1) - X1(1 - 1), (X3(3 - 1) - X1(3 - 1)) * sin(X1(4 - 1)),
                      a1(2 - 1) * X2(2 - 1) - o1(2 - 1) * X2(3 - 1),
                      0, -X2(1 - 1) * cos(X1(5 - 1)) - X2(2 - 1) * sin(X1(5 - 1)) * sin(X1(6 - 1)) -
                         X2(3 - 1) * sin(X1(5 - 1)) * cos(X1(6 - 1)), a1(3 - 1) * X2(2 - 1) - o1(3 - 1) * X2(3 - 1)};
    mat M(3, 3);
    for (int i = 0; i < 9; i++)
        M(i) = Marr[i];
    M = trans(M);
    ...
    double K1arr[9] = {1, sin(X3(5 - 1)) * sin(X3(4 - 1) - X1(4 - 1)) / cos(X3(5 - 1)),
                       ...
                       0, sin(X3(4 - 1) - X1(4 - 1)) / cos(X3(5 - 1)),
...
mat Jplus2(const colvec &X1, const colvec &X2) {
    ...
    double K2arr[9] = {cos(X2(5 - 1)) * cos(X3(6 - 1) - X2(6 - 1)) / cos(X3(5 - 1)),
                       sin(X3(6 - 1) - X2(6 - 1)) / cos(X3(5 - 1)), 0,
...
mat jacobianF(const colvec &X, const colvec &U, double dt) {
    ...
    F(0, 1) = 0;
    F(0, 2) = 0;
    F(0, 3) = (dt * dt * (ay * (sin(ro) * sin(ya) + cos(ro) * cos(ya) * sin(pt)) +
                          az * (cos(ro) * sin(ya) - cos(ya) * sin(pt) * sin(ro)))) / 2,
            F(0, 4) = (dt * dt *
                       (az * cos(pt) * cos(ro) * cos(ya) - ax * cos(ya) * sin(pt) + ay * cos(pt) * cos(ya) * sin(ro))) /
                      2;
    F(0, 5) = -(dt * dt * (ay * (cos(ro) * cos(ya) + sin(pt) * sin(ro) * sin(ya)) -
                           az * (cos(ya) * sin(ro) - cos(ro) * sin(pt) * sin(ya)) + ax * cos(pt) * sin(ya))) / 2;
    F(0, 6) = dt;
    F(0, 7) = 0;
    F(0, 8) = 0;
    ...
    F(1, 1) = 1;
    F(1, 2) = 0;
    F(1, 3) = -(dt * dt * (ay * (cos(ya) * sin(ro) - cos(ro) * sin(pt) * sin(ya)) +
                           az * (cos(ro) * cos(ya) + sin(pt) * sin(ro) * sin(ya)))) / 2;
    F(1, 4) =
            (dt * dt * (az * cos(pt) * cos(ro) * sin(ya) - ax * sin(pt) * sin(ya) + ay * cos(pt) * sin(ro) * sin(ya))) /
            2;
    F(1, 5) = (dt * dt * (az * (sin(ro) * sin(ya) + cos(ro) * cos(ya) * sin(pt)) -
                          ay * (cos(ro) * sin(ya) - cos(ya) * sin(pt) * sin(ro)) + ax * cos(pt) * cos(ya))) / 2;
    F(1, 6) = 0;
    F(1, 7) = dt;
    F(1, 8) = 0;
